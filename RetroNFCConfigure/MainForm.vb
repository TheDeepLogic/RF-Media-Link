...
Public Class MainForm
    ...
    Private Sub InitializeComponent()
        Me.Text = "RetroNFC Configuration"
    ...
    Private Sub FindConfigDir()
        ' Check AppData first
        Dim appDataPath As String = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "RetroNFC")
        ...
        Else
            ...
            Dim progFilesPath As String = "C:\Program Files\RetroNFC"
